...
const ReadyToSendScreenEng: React.FC = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <Image source={require('../../assets/images/edit.png')} style={styles.image} />
                <Text style={styles.title}>Nothing ready to send</Text>
                <Text style={styles.subtitle}>When you finalize drafts, they will appear here.</Text>
            </View>
        </View>
    );
};
